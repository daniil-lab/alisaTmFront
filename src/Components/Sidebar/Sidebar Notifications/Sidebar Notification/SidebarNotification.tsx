...
const SidebarNotification: React.FunctionComponent<ISidebarNotification> = ({ text, description }) => {
    return (
        <div className="sidebar-notification-block">
            {description ? <p className="sidebar-notification-description">{description}</p> : null}
